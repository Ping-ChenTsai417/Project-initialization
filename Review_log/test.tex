...
\textcolor{blue}{People with Dementia are at greater risk of fall.Cognitive impairment is an independent risk factor for falls. Mobility problems experienced with dementia are associated with falls, fractures, and admission to long‐term care. At this time, there is insufficient evidence to recommend, for or against, single or multifactorial interventions in community‐living older adults with known cognitive impairment \cite{PreventionofFalls2011}.}
...
motor control theories: 1)reflex theory(1906, Sherrington) 2)System Model. Goeal-directed \& Task-oriented. 
